        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 md:p-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-3">
                    <span class="text-blue-700 text-xs font-bold uppercase tracking-wider">{{ $isEnglish ? 'Information' : 'Informasi' }}</span>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-gray-50 rounded-xl p-6">
                        <h3 class="font-bold text-gray-900 mb-4">{{ $isEnglish ? 'Publication Categories' : 'Kategori Publikasi' }}</h3>
                        <ul class="space-y-3">
                            <li>
