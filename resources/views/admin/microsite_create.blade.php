...
@section('title', 'Buat Microsite')

@section('content')
<div class="max-w-4xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Buat Microsite</h1>
            <p class="text-sm text-gray-500 mt-1">Buat halaman event atau microsite baru.</p>
        </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="{{ route('admin.microsite.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="layout" class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition">
                        ...
                        <option value="centered" {{ old('layout') == 'centered' ? 'selected' : '' }}>Centered</option>
                    </select>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="custom_css" rows="3" placeholder="Tambahkan custom CSS untuk microsite ini..."
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition">{{ old('custom_css') }}</textarea>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea name="custom_js" rows="3" placeholder="Tambahkan custom JavaScript untuk microsite ini..."
                        class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition">{{ old('custom_js') }}</textarea>
                </div>
            </div>
