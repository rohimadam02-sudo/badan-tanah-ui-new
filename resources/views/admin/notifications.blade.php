        ...
        <div class="divide-y divide-gray-100">
            ...
            @forelse($notifications as $item)
                ...
                <div class="flex items-start gap-4 px-6 py-4 hover:bg-gray-50 transition group">
                    <div class="w-10 h-10 rounded-xl bg-{{ $iconBg }} flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-4 mt-1.5">
                            ...
                            @if($link != '#')
                                <a href="{{ $link }}" class="text-xs font-semibold text-blue-600 hover:underline">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            ...
            <p class="text-2xl font-bold text-orange-600">
                {{ $notifications->where('type', 'pending_approval')->count() }}
            </p>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-4">
            <p class="text-xs text-gray-500">Pesan Belum Dibaca</p>
            <p class="text-2xl font-bold text-blue-600">
                {{ $notifications->where('type', 'unread_contact')->count() }}
            </p>
        </div>
    </div>
