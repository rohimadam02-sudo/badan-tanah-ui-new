        ...
        <form action="{{ route('admin.lokasi-kantor.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" step="0.0000001" name="lat" value="{{ old('lat', '-6.1754') }}"
                           placeholder="-6.1754"
                           class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition"
                           required>
                    @error('lat')
                ...
                <div>
                    ...
                    <input type="number" step="0.0000001" name="lng" value="{{ old('lng', '106.8272') }}"
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        <input type="color" name="warna" id="warnaPicker" value="{{ old('warna', '#006400') }}"
                               class="w-14 h-14 border border-gray-300 rounded-lg cursor-pointer">
                        <input type="text" name="warna" id="warnaText" value="{{ old('warna', '#006400') }}"
                               placeholder="#006400"
