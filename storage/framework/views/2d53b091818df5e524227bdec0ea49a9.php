...
<div class="max-w-7xl mx-auto">
    ...
    <form action="<?php echo e(route('admin.aset.store')); ?>" method="POST" enctype="multipart/form-data" id="assetForm">
        <?php echo csrf_field(); ?>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="peruntukan" class="w-full border-gray-300 rounded-lg p-3 text-sm" required>
                                        ...
                                        <option value="Industri" <?php echo e(old('peruntukan') == 'Industri' ? 'selected' : ''); ?>>Industri</option>
                                        <option value="Pertanian" <?php echo e(old('peruntukan') == 'Pertanian' ? 'selected' : ''); ?>>Pertanian</option>
                                        <option value="Perumahan" <?php echo e(old('peruntukan') == 'Perumahan' ? 'selected' : ''); ?>>Perumahan</option>
                                        <option value="Komersial" <?php echo e(old('peruntukan') == 'Komersial' ? 'selected' : ''); ?>>Komersial</option>
                                        <option value="Sosial" <?php echo e(old('peruntukan') == 'Sosial' ? 'selected' : ''); ?>>Sosial</option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="status" class="w-full border-gray-300 rounded-lg p-3 text-sm" required>
                                        ...
                                        <option value="Dalam Pengembangan" <?php echo e(old('status') == 'Dalam Pengembangan' ? 'selected' : ''); ?>>Dalam Pengembangan</option>
                                        <option value="Dalam Proses" <?php echo e(old('status') == 'Dalam Proses' ? 'selected' : ''); ?>>Dalam Proses</option>
                                        <option value="Terikat" <?php echo e(old('status') == 'Terikat' ? 'selected' : ''); ?>>Terikat</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="skema" class="w-full border-gray-300 rounded-lg p-3 text-sm">
                                        ...
                                        <option value="Sewa" <?php echo e(old('skema') == 'Sewa' ? 'selected' : ''); ?>>Sewa</option>
                                        <option value="Kerjasama" <?php echo e(old('skema') == 'Kerjasama' ? 'selected' : ''); ?>>Kerjasama</option>
                                        <option value="Pemanfaatan" <?php echo e(old('skema') == 'Pemanfaatan' ? 'selected' : ''); ?>>Pemanfaatan</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select name="sumber_perolehan" class="w-full border-gray-300 rounded-lg p-3 text-sm">
                                    ...
                                    <option value="Pembelian" <?php echo e(old('sumber_perolehan') == 'Pembelian' ? 'selected' : ''); ?>>Pembelian</option>
                                    <option value="Sewa" <?php echo e(old('sumber_perolehan') == 'Sewa' ? 'selected' : ''); ?>>Sewa</option>
                                    <option value="Hibah" <?php echo e(old('sumber_perolehan') == 'Hibah' ? 'selected' : ''); ?>>Hibah</option>
                                    <option value="Tukar Menukar" <?php echo e(old('sumber_perolehan') == 'Tukar Menukar' ? 'selected' : ''); ?>>Tukar Menukar</option>
                                    <option value="Lelang" <?php echo e(old('sumber_perolehan') == 'Lelang' ? 'selected' : ''); ?>>Lelang</option>
                                    <option value="Pengadaan" <?php echo e(old('sumber_perolehan') == 'Pengadaan' ? 'selected' : ''); ?>>Pengadaan</option>
                                </select>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold mb-1">Nilai Perkiraan</label>
                                <input type="text" name="nilai_perkiraan" value="<?php echo e(old('nilai_perkiraan')); ?>" placeholder="Rp" class="w-full border-gray-300 rounded-lg p-3 text-sm">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="tahun_perolehan" value="<?php echo e(old('tahun_perolehan')); ?>" placeholder="2025" class="w-full border-gray-300 rounded-lg p-3 text-sm">
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u250369146/laravel-app/resources/views/admin/aset_create.blade.php ENDPATH**/ ?>