...
<?php $__env->startSection('title', 'Lokasi Kantor'); ?>
...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6 flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('admin.lokasi-kantor.create')); ?>" 
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm">
                ...
                <tbody class="divide-y divide-gray-100" id="sortableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $lokasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition" data-id="<?php echo e($item->id); ?>">
                        <td class="px-4 py-4">
                            <i class="fas fa-grip-vertical text-gray-300 cursor-move"></i>
                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-2">
                                <span class="font-medium"><?php echo e($item->nama); ?></span>
                                <?php if($item->is_utama): ?>
                                    <span class="text-[9px] font-bold px-1.5 py-0.5 rounded bg-yellow-100 text-yellow-700">Utama</span>
                                <?php endif; ?>
                            </div>
                        </td>
                        <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($item->alamat); ?></td>
                        <td class="px-6 py-4 text-sm text-gray-600">
                            <?php echo e($item->lat); ?>, <?php echo e($item->lng); ?>

                        </td>
                        <td class="px-6 py-4">
                            <button type="button" onclick="toggleStatus(<?php echo e($item->id); ?>)"
                                    class="px-2 py-1 rounded text-xs font-bold transition
                                    <?php echo e($item->is_active ? 'bg-green-100 text-green-700 hover:bg-green-200' : 'bg-gray-100 text-gray-500 hover:bg-gray-200'); ?>">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('admin.lokasi-kantor.edit', $item->id)); ?>" 
                                   class="text-blue-600 hover:text-blue-800" title="Edit">
                                    <i class="fas fa-pen"></i>
                                </a>
                                <form action="<?php echo e(route('admin.lokasi-kantor.destroy', $item->id)); ?>" method="POST" class="inline"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('admin.lokasi-kantor.create')); ?>" class="text-[#006400] hover:underline text-sm font-semibold">
                                Tambah lokasi
                            </a>
                        </td>
                    </tr>
    ...
    if (tbody) {
        new Sortable(tbody, {
            ...
            onEnd: function() {
                ...
                fetch('<?php echo e(route('admin.lokasi-kantor.update-order')); ?>', {
                    method: 'POST',
                    headers: {
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/lokasi_kantor_index.blade.php ENDPATH**/ ?>