                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 mt-0.5"><?php echo e($footer->alamat ?? 'Jl. H. Juanda No. 15, Jakarta Pusat'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 mt-0.5"><?php echo e($footer->telepon ?? '(021) 3456-7890'); ?></p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-700 mt-0.5"><?php echo e($footer->email ?? 'info@bantah.go.id'); ?></p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex flex-wrap gap-3">
                            <?php $__currentLoopData = $socialMedias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $social): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e($social->url); ?>" target="_blank" rel="noopener noreferrer"
                                   ...
                                   style="background-color: <?php echo e($social->warna ?? '#6b7280'); ?>; color: white;"
                                   title="<?php echo e($social->nama); ?>"
                                   aria-label="<?php echo e($social->nama); ?>">
                                    <i class="<?php echo e($social->icon); ?> text-lg group-hover:scale-110 transition" aria-hidden="true"></i>
                                </a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </div>
                    </div>
...
<div class="mt-12">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500">
                        <?php echo e($lokasiKantor->count()); ?> lokasi
                        <?php if($lokasiKantor->where('is_utama', true)->count() > 0): ?>
                            • <?php echo e($lokasiKantor->where('is_utama', true)->first()->nama); ?> (Kantor Utama)
                        <?php endif; ?>
                    </p>
                </div>
            </div>
        ...
        <div class="p-4 border-t border-gray-100">
            <div class="flex flex-wrap gap-3">
                <?php $__currentLoopData = $lokasiKantor; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="flex items-center gap-2 text-xs">
                        <span class="w-3 h-3 rounded-full" style="background-color: <?php echo e($lokasi->warna ?? '#006400'); ?>;"></span>
                        <span class="text-gray-600"><?php echo e($lokasi->nama); ?></span>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    var lokasiData = <?php echo json_encode($lokasiKantor, 15, 512) ?>;
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/frontend/kontak.blade.php ENDPATH**/ ?>