...
<div class="max-w-7xl mx-auto">
    <div class="flex justify-between items-center mb-6 flex-wrap gap-3">
        ...
        <a href="<?php echo e(route('admin.social-media.create')); ?>" 
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left text-sm" id="socialMediaTable">
                ...
                <tbody class="divide-y divide-gray-100" id="sortableBody">
                    <?php $__empty_1 = true; $__currentLoopData = $socialMedias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50 transition" data-id="<?php echo e($item->id); ?>">
                        ...
                        <td class="px-6 py-4">
                            <div class="w-10 h-10 rounded-lg flex items-center justify-center text-white text-lg"
                                 style="background-color: <?php echo e($item->warna ?? '#6b7280'); ?>">
                                <i class="<?php echo e($item->icon); ?>"></i>
                            </div>
                        </td>
                        <td class="px-6 py-4 font-medium"><?php echo e($item->nama); ?></td>
                        <td class="px-6 py-4 text-gray-500 truncate max-w-[200px]">
                            <a href="<?php echo e($item->url); ?>" target="_blank" class="text-blue-600 hover:underline">
                                <?php echo e($item->url); ?>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex gap-2">
                                <a href="<?php echo e(route('admin.social-media.edit', $item->id)); ?>" 
                                   class="text-blue-600 hover:text-blue-800" title="Edit">
                                    <i class="fas fa-pen"></i>
                                </a>
                                <form action="<?php echo e(route('admin.social-media.destroy', $item->id)); ?>" method="POST" class="inline"
                    ...
                    <tr>
                        <td colspan="6" class="px-6 py-12 text-center text-gray-500">
                            ...
                            <a href="<?php echo e(route('admin.social-media.create')); ?>" class="text-[#006400] hover:underline text-sm font-semibold">
                                Tambah social media
                            </a>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/admin/social_media_index.blade.php ENDPATH**/ ?>