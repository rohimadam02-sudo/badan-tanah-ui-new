...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Badan Bank Tanah'); ?></title>
    ...
    <footer class="text-white mt-20" style="background-color: <?php echo e($pengaturan->warna_utama ?? '#0B2A4A'); ?>;">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 border-b border-white/10">
            ...
            <div>
                <div class="flex items-center gap-3 mb-4">
                    <div class="flex items-center justify-center w-12 h-12 rounded">
                        <img src="<?php echo e(asset('images/Logo-badan-bank-tanah.png')); ?>" alt="Logo"
            ...
            <div>
                ...
                <?php if($footer->show_social_media): ?>
                    <div class="flex flex-wrap gap-3 mt-4">
                        <?php if($footer->facebook && $footer->facebook != '#'): ?>
                            <a href="<?php echo e($footer->facebook); ?>" target="_blank" rel="noopener noreferrer" 
                        ...
                        <?php endif; ?>
                        <?php if($footer->twitter && $footer->twitter != '#'): ?>
                            <a href="<?php echo e($footer->twitter); ?>" target="_blank" rel="noopener noreferrer" 
                               class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition group"
                               title="Twitter / X">
                                <i class="fab fa-twitter text-sm group-hover:scale-110 transition"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footer->instagram && $footer->instagram != '#'): ?>
                            <a href="<?php echo e($footer->instagram); ?>" target="_blank" rel="noopener noreferrer" 
                               class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition group"
                               title="Instagram">
                                <i class="fab fa-instagram text-sm group-hover:scale-110 transition"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footer->linkedin && $footer->linkedin != '#'): ?>
                            <a href="<?php echo e($footer->linkedin); ?>" target="_blank" rel="noopener noreferrer" 
                               class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition group"
                               title="LinkedIn">
                                <i class="fab fa-linkedin-in text-sm group-hover:scale-110 transition"></i>
                            </a>
                        <?php endif; ?>
                        <?php if($footer->youtube && $footer->youtube != '#'): ?>
                            <a href="<?php echo e($footer->youtube); ?>" target="_blank" rel="noopener noreferrer" 
                               class="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition group"
                               title="YouTube">
...
</html><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/layouts/frontend.blade.php ENDPATH**/ ?>