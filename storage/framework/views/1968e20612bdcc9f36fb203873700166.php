...
<div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            ...
            <h3 class="text-2xl font-bold text-gray-900 mt-2"><?php echo e(number_format($totalAset)); ?></h3>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Total Luas</p>
            <h3 class="text-2xl font-bold text-green-600 mt-2"><?php echo e(number_format($totalLuas, 2, ',', '.')); ?> Ha</h3>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Provinsi</p>
            <h3 class="text-2xl font-bold text-blue-600 mt-2"><?php echo e(number_format($totalProvinsi)); ?></h3>
        </div>
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <p class="text-[10px] font-semibold uppercase tracking-wide text-gray-400">Kabupaten/Kota</p>
            <h3 class="text-2xl font-bold text-purple-600 mt-2"><?php echo e(number_format($totalKabupaten)); ?></h3>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-5">
        <div class="bg-green-50 border border-green-100 rounded-xl p-4">
            ...
            <p class="text-[8px] text-green-500"><?php echo e($totalAset > 0 ? round(($totalTersedia / $totalAset) * 100) : 0); ?>%</p>
        </div>
        <div class="bg-blue-50 border border-blue-100 rounded-xl p-4">
            ...
            <p class="text-[8px] text-blue-500"><?php echo e($totalAset > 0 ? round(($totalPengembangan / $totalAset) * 100) : 0); ?>%</p>
        </div>
        <div class="bg-orange-50 border border-orange-100 rounded-xl p-4">
            ...
            <p class="text-[8px] text-orange-500"><?php echo e($totalAset > 0 ? round(($totalProses / $totalAset) * 100) : 0); ?>%</p>
        </div>
        <div class="bg-gray-50 border border-gray-100 rounded-xl p-4">
            ...
            <p class="text-[8px] text-gray-500"><?php echo e($totalAset > 0 ? round(($totalTerikat / $totalAset) * 100) : 0); ?>%</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-5">
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-5 space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $peruntukanData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[10px] font-semibold text-gray-700"><?php echo e($item->peruntukan); ?></span>
                            <span class="text-[10px] font-bold text-gray-900"><?php echo e(number_format($item->total)); ?></span>
                        </div>
                        <div class="w-full h-2 rounded-full bg-gray-100 overflow-hidden">
                            <div class="h-full rounded-full bg-blue-500" style="width: <?php echo e($maxTotal > 0 ? ($item->total / $maxTotal) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
            ...
            <div class="p-5 space-y-4">
                <?php $__empty_1 = true; $__currentLoopData = $skemaData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div>
                        <div class="flex items-center justify-between mb-2">
                            <span class="text-[10px] font-semibold text-gray-700"><?php echo e($item->skema); ?></span>
                            <span class="text-[10px] font-bold text-gray-900"><?php echo e(number_format($item->total)); ?></span>
                        </div>
                        <div class="w-full h-2 rounded-full bg-gray-100 overflow-hidden">
                            <div class="h-full rounded-full bg-green-500" style="width: <?php echo e($maxTotal > 0 ? ($item->total / $maxTotal) * 100 : 0); ?>%"></div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div class="px-5 py-4 border-b border-gray-100 flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.aset.wilayah')); ?>" class="text-[9px] font-semibold text-[#006400] hover:underline">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php $__empty_1 = true; $__currentLoopData = $provinsiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-5 py-4 text-[10px] font-semibold text-gray-800"><?php echo e($item->provinsi); ?></td>
                            <td class="px-5 py-4 text-[10px] text-gray-600"><?php echo e(number_format($item->total)); ?></td>
                            <td class="px-5 py-4 text-[10px] text-gray-600"><?php echo e(number_format($item->total_luas, 0, ',', '.')); ?> Ha</td>
                            <td class="px-5 py-4">
                                <div class="flex items-center gap-2">
                                    <div class="w-24 h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                        <div class="h-full bg-[#006400] rounded-full" style="width: <?php echo e($totalAset > 0 ? ($item->total / $totalAset) * 100 : 0); ?>%"></div>
                                    </div>
                                    <span class="text-[9px] font-semibold text-gray-600"><?php echo e($totalAset > 0 ? round(($item->total / $totalAset) * 100) : 0); ?>%</span>
                                </div>
                            </td>
                        </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/aset_statistik.blade.php ENDPATH**/ ?>