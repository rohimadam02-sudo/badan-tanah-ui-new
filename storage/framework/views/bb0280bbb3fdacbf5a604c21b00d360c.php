...
<form action="<?php echo e(route('admin.berita.store')); ?>" method="POST" enctype="multipart/form-data" id="beritaForm">
    <?php echo csrf_field(); ?>
    ...
    <!-- ========================================================= -->
    <div id="successBanner" class="success-banner <?php echo e(session('success') ? 'show' : ''); ?>">
        <div class="flex">
            <div class="icon">
            ...
            <div class="flex-1">
                ...
                <p class="message" id="successMessage"><?php echo e(session('success') ?? 'Data berhasil disimpan!'); ?></p>
            </div>
    ...
    <!-- PESAN ERROR -->
    <div id="errorContainer" class="<?php echo e($errors->any() ? '' : 'hidden'); ?>">
        ...
        <div class="lg:col-span-2 space-y-6">
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="judul" id="judul" value="<?php echo e(old('judul')); ?>"
                            ...
                            <?php echo e($errors->has('judul') ? 'input-error shake' : ''); ?>"
                            required>
                        <div class="field-error <?php echo e($errors->has('judul') ? 'show' : ''); ?>" id="judulError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            <?php echo e($errors->first('judul') ?: 'Judul berita wajib diisi.'); ?>
                    ...
                    <div>
                        ...
                        <textarea name="ringkasan" id="ringkasan" rows="3"
                            ...
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                            <?php echo e($errors->has('ringkasan') ? 'input-error shake' : ''); ?>"><?php echo e(old('ringkasan')); ?></textarea>
                        <div class="field-error <?php echo e($errors->has('ringkasan') ? 'show' : ''); ?>" id="ringkasanError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="kategori" id="kategori" required
                                class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                                <?php echo e($errors->has('kategori') ? 'input-error shake' : ''); ?>">
                                <option value="">Pilih Kategori</option>
                                <option value="Berita" <?php echo e(old('kategori') == 'Berita' ? 'selected' : ''); ?>>Berita</option>
                                <option value="Siaran Pers" <?php echo e(old('kategori') == 'Siaran Pers' ? 'selected' : ''); ?>>Siaran Pers</option>
                                <option value="Pengumuman" <?php echo e(old('kategori') == 'Pengumuman' ? 'selected' : ''); ?>>Pengumuman</option>
                            </select>
                            <div class="field-error <?php echo e($errors->has('kategori') ? 'show' : ''); ?>" id="kategoriError">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                <?php echo e($errors->first('kategori') ?: 'Kategori wajib dipilih.'); ?>
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_publikasi"
                                value="<?php echo e(old('tanggal_publikasi', date('Y-m-d'))); ?>"
                                class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                                <?php echo e($errors->has('tanggal_publikasi') ? 'input-error shake' : ''); ?>">
                            <div class="field-error <?php echo e($errors->has('tanggal_publikasi') ? 'show' : ''); ?>" id="tanggal_publikasiError">
                                <i class="fas fa-exclamation-circle mr-1"></i>
                                <?php echo e($errors->first('tanggal_publikasi')); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
                ...
                <textarea name="konten" id="editor" rows="12" required
                    ...
                    <?php echo e($errors->has('konten') ? 'input-error shake' : ''); ?>"><?php echo e(old('konten')); ?></textarea>
                <div class="field-error <?php echo e($errors->has('konten') ? 'show' : ''); ?>" id="kontenError">
                    <i class="fas fa-exclamation-circle mr-1"></i>
                    <?php echo e($errors->first('konten') ?: 'Konten berita wajib diisi.'); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="metaTitle" placeholder="Masukkan meta title"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                            <?php echo e($errors->has('meta_title') ? 'input-error shake' : ''); ?>"
                            value="<?php echo e(old('meta_title')); ?>">
                        <div class="field-error <?php echo e($errors->has('meta_title') ? 'show' : ''); ?>" id="meta_titleError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div>
                        ...
                        <input type="text" name="meta_description" id="metaDescription" placeholder="Masukkan meta description"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                            <?php echo e($errors->has('meta_description') ? 'input-error shake' : ''); ?>"
                            value="<?php echo e(old('meta_description')); ?>">
                        <div class="field-error <?php echo e($errors->has('meta_description') ? 'show' : ''); ?>" id="meta_descriptionError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="slug" id="slug" placeholder="berita/..." 
                                ...
                                <?php echo e($errors->has('slug') ? 'input-error shake' : ''); ?>"
                                value="<?php echo e(old('slug')); ?>">
                        </div>
                        <div class="field-error <?php echo e($errors->has('slug') ? 'show' : ''); ?>" id="slugError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <select name="status" id="statusSelect"
                            class="w-full border border-gray-300 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#006400]/30 focus:border-[#006400] transition
                            <?php echo e($errors->has('status') ? 'input-error shake' : ''); ?>">

                            <?php if(in_array($role, ['super_admin', 'admin'])): ?>
                                <option value="Draft" <?php echo e(old('status') == 'Draft' ? 'selected' : ''); ?>>Draft</option>
                                <option value="Menunggu Approval" <?php echo e(old('status') == 'Menunggu Approval' ? 'selected' : ''); ?>>Menunggu Approval</option>
                                <option value="Terbit" <?php echo e(old('status') == 'Terbit' ? 'selected' : ''); ?>>Terbit</option>
                        ...
                        <div class="field-error <?php echo e($errors->has('status') ? 'show' : ''); ?>" id="statusError">
                            <i class="fas fa-exclamation-circle mr-1"></i>
                            ...
                            <div class="mt-2 bg-green-50 border border-green-100 rounded-lg p-3">
                                <div class="flex items-start gap-2">
                                    ...
                                    <p class="text-xs text-green-700 leading-relaxed">
                                        Sebagai <strong><?php echo e($role == 'super_admin' ? 'Super Admin' : 'Admin'); ?></strong>,
                    ...
                    <div>
                        ...
                        <input type="text" name="penulis" value="<?php echo e(auth()->user()->name); ?>" readonly
                ...
                <div class="space-y-4 text-sm">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-gray-500 text-xs"><?php echo e(auth()->user()->name); ?></p>
                            <p class="text-gray-400 text-[10px]"><?php echo e(now()->format('d M Y H:i')); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/berita_create.blade.php ENDPATH**/ ?>