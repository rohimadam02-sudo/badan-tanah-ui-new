<?php $__env->startSection('title', 'FAQ - Badan Bank Tanah'); ?>
...
<section class="bg-gray-50 py-12 md:py-16">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 md:p-6 mb-8">
            ...
            <div class="flex flex-wrap gap-2 mt-3" id="categoryFilter">
                ...
                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <button type="button" class="filter-btn px-4 py-1.5 rounded-full text-xs font-medium bg-gray-100 text-gray-600 hover:bg-gray-200 transition" data-kategori="<?php echo e($cat); ?>">
                        <?php echo e($cat); ?>
        ...
        <div class="space-y-4" id="faqList">
            ...
            <div class="faq-item bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden transition hover:shadow-md" data-kategori="<?php echo e($faq->kategori); ?>">
                <button type="button" class="faq-toggle w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-gray-50 transition group">
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <span class="text-[10px] font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full"><?php echo e($faq->kategori); ?></span>
                ...
                <div class="faq-answer hidden px-6 pb-5 pt-0 border-t border-gray-100">
                    <div class="flex items-start gap-4 pt-4">
                        ...
                        <p class="text-sm text-gray-600 leading-relaxed"><?php echo e($faq->jawaban); ?></p>
                    </div>
                </div>
            </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/frontend/faq.blade.php ENDPATH**/ ?>