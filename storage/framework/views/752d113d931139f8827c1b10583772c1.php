...
<?php $__env->startSection('content'); ?>
                ...
                <div class="bg-[#0B2A4A] rounded-2xl p-7 text-white">
                    ...
                    <div class="mt-6 space-y-3">
                        ...
                        <div class="flex items-center gap-3 text-sm">
                            ...
                            <?php echo e($isEnglish ? 'Utilization scheme information' : 'Informasi skema pemanfaatan'); ?>
    ...
    <section class="bg-gray-50 dark:bg-gray-900 border-y border-gray-100 dark:border-gray-800">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div class="text-center max-w-2xl mx-auto mb-10">
                ...
                <h2 class="text-2xl md:text-3xl
                       font-extrabold text-gray-900 dark:text-white mt-2">
                ...
                <p class="text-gray-500 dark:text-gray-400 text-sm leading-relaxed mt-3">

                    <?php echo e($isEnglish ? 'Scheme information that can be managed through CMS.' : 'Informasi skema yang dapat dikelola melalui CMS.'); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $skemaList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $skema): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div id="skema-<?php echo e($index); ?>"
                        ...
                        <div
                            class="w-12 h-12 rounded-xl
                                bg-[#0B2A4A]/10 dark:bg-[#0B2A4A]/30
                                text-[#0B2A4A] dark:text-blue-300
                        ...
                        <h3 class="text-lg font-bold text-gray-900 dark:text-white mt-5">
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <a href="#skema-<?php echo e($index); ?>"
                                class="text-xs font-semibold link-secondary hover:underline inline-flex items-center gap-1 transition group dark:text-blue-400">

                                <?php echo e($isEnglish ? 'Scheme information' : 'Informasi skema'); ?>


                                <i
                                    class="fas fa-arrow-right text-[10px] transition-transform group-hover:translate-x-1 dark:text-blue-400"></i>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                dark:shadow-lg dark:shadow-black/20">
                        ...
                        <div class="flex items-center justify-between">
                         ...
                         text-[#0B2A4A]/20 dark:text-blue-400/30">
                        ...
                        text-[#0B2A4A]/40 dark:text-blue-400/70"></i>

                        </div>

                        <h3 class="font-bold text-lg text-gray-900 dark:text-white mt-5">
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/frontend/partnership.blade.php ENDPATH**/ ?>