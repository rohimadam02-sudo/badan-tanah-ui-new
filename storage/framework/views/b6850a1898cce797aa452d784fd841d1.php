    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-20">
        ...
        <div class="max-w-3xl">
            ...
            <span class="inline-flex items-center px-4 py-1.5 rounded-full
                         bg-white/10 border border-white/10 text-blue-200 text-xs font-semibold
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 md:p-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-3">
                    <span class="text-blue-700 text-xs font-bold uppercase tracking-wider"><?php echo e($isEnglish ? 'Information' : 'Informasi'); ?></span>
                    <h2 class="text-2xl md:text-3xl font-bold text-gray-900 mt-2 mb-5">
                        <?php echo e($isEnglish ? ($halaman->judul_en ?? $halaman->judul) : $halaman->judul); ?>
                ...
                <div class="lg:col-span-2">
                    <div class="bg-gray-50 rounded-xl p-6">
                        <h3 class="font-bold text-gray-900 mb-4"><?php echo e($isEnglish ? 'Publication Categories' : 'Kategori Publikasi'); ?></h3>
                        <ul class="space-y-3">
                            <li>
