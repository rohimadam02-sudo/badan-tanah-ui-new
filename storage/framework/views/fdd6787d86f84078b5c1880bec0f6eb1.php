...
<?php $__env->startSection('content'); ?>
        ...
        <div class="max-w-7xl mx-auto bg-white rounded-2xl shadow-lg px-4 sm:px-6 md:px-10 py-4 sm:py-6">
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 md:gap-6">
                ...
                <div class="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 sm:py-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-[8px] sm:text-[10px] text-gray-500 font-medium truncate">
                            <?php echo e($statLabels['total_luas']); ?></p>
                        <p class="text-sm sm:text-base md:text-xl font-extrabold text-gray-900">
                            <?php echo e(number_format($totalLuas, 0, ',', '.')); ?> Ha</p>
                        <p class="text-[7px] sm:text-[8px] text-green-600">
                            <?php echo e($isEnglish ? 'Real data' : 'Data real dari database'); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 sm:py-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-[8px] sm:text-[10px] text-gray-500 font-medium truncate">
                            <?php echo e($statLabels['total_asets']); ?></p>
                        <p class="text-sm sm:text-base md:text-xl font-extrabold text-gray-900">
                            <?php echo e(number_format($totalAset)); ?></p>
                        <p class="text-[7px] sm:text-[8px] text-gray-400 truncate">
                            <?php echo e($isEnglish ? 'Land Plots' : 'Bidang Tanah'); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 sm:py-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-[8px] sm:text-[10px] text-gray-500 font-medium truncate">
                            <?php echo e($statLabels['wilayah']); ?></p>
                        <p class="text-sm sm:text-base md:text-xl font-extrabold text-gray-900">
                            <?php echo e(number_format($totalProvinsi)); ?></p>
                        <p class="text-[7px] sm:text-[8px] text-gray-400 truncate">
                            <?php echo e($isEnglish ? 'Provinces' : 'Provinsi'); ?></p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-2 sm:gap-3 px-2 sm:px-3 py-2 sm:py-3">
                    ...
                    <div class="min-w-0">
                        <p class="text-[8px] sm:text-[10px] text-gray-500 font-medium truncate">
                            <?php echo e($statLabels['kerjasama']); ?></p>
                        <p class="text-sm sm:text-base md:text-xl font-extrabold text-gray-900">
                            <?php echo e($totalKerjasama > 0 ? number_format($totalKerjasama) : '0'); ?></p>
                        <p class="text-[7px] sm:text-[8px] text-gray-400 truncate">
                            <?php echo e($isEnglish ? 'Strategic Partners' : 'Mitra Strategis'); ?></p>
                    </div>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-[1.35fr_0.85fr] gap-6 sm:gap-8 lg:gap-10">
                ...
                <div class="flex items-end justify-between mb-4 sm:mb-5">
                    <div>
                        <h2 class="text-base sm:text-lg font-bold text-gray-900">
                            <?php echo e($isEnglish ? 'Land Asset Inventory' : 'Aset Persediaan Tanah'); ?></h2>
                    </div>
                                ...
                                <div
                                    ...
                                    <div class="relative h-36 sm:h-40 md:h-48 bg-gray-200">
                                        <img src="<?php echo e($aset->gambar ? asset('storage/' . $aset->gambar) : 'https://picsum.photos/600/400?random=' . $aset->id); ?>"
                                            class="w-full h-full object-cover" alt="<?php echo e($aset->nama_lokasi); ?>"
                                            loading="lazy">
                                        <span
            ...
            <div class="bg-white rounded-xl shadow-md p-4 sm:p-5">
                <div class="flex items-end justify-between mb-3 sm:mb-4">
                    <div>
                        <h2 class="text-base sm:text-lg font-bold text-gray-900">
                            <?php echo e($isEnglish ? 'Interactive Map' : 'Peta Interaktif'); ?></h2>
                    </div>
                    <a href="<?php echo e(route('assets')); ?>" class="text-[10px] font-semibold link-secondary">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-10">
            ...
            <div class="lg:col-span-3">
                <div class="flex items-end justify-between mb-5 sm:mb-7">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-900">
                        <?php echo e($isEnglish ? 'Utilization & Partnerships' : 'Pemanfaatan & Kerja Sama'); ?></h2>
                ...
                <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 md:gap-6">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xs sm:text-sm font-bold text-gray-900">
                            <?php echo e($isEnglish ? 'Investment' : 'Investasi'); ?></h3>
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xs sm:text-sm font-bold text-gray-900">
                            <?php echo e($isEnglish ? 'Agrarian Reform' : 'Reforma Agraria'); ?></h3>
                        <p class="text-[8px] sm:text-[10px] text-gray-500 leading-relaxed mt-0.5 sm:mt-1 hidden sm:block">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xs sm:text-sm font-bold text-gray-900">
                            <?php echo e($isEnglish ? 'Partnership' : 'Kerja Sama'); ?></h3>
                        <p class="text-[8px] sm:text-[10px] text-gray-500 leading-relaxed mt-0.5 sm:mt-1 hidden sm:block">
                    ...
                    <div class="text-center">
                        ...
                        <h3 class="text-xs sm:text-sm font-bold text-gray-900"><?php echo e($isEnglish ? 'Documents' : 'Dokumen'); ?>
            ...
            <div class="lg:col-span-2">
                <div class="flex items-end justify-between mb-5 sm:mb-7">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-900">
                        <?php echo e($isEnglish ? 'Latest Publications' : 'Publikasi Terbaru'); ?></h2>
    ...
    <div class="relative overflow-hidden bg-[#0B2A4A] max-h-[260px] sm:max-h-[300px] lg:max-h-[340px]">
        ...
        <div class="absolute inset-0 bg-cover bg-no-repeat"
            style="background-image: url('<?php echo e(asset('images/footer.png')); ?>');
            ...
            <div class="max-w-xl text-left">
                ...
                <div class="flex items-start gap-3 mb-2 sm:mb-3">
                    ...
                    <h2 class="text-lg sm:text-xl lg:text-2xl font-bold text-yellow-400 leading-tight">
                        <?php echo e($isEnglish ? 'Together Managing Land for a Better Future of Indonesia' : 'Bersama Mengelola Tanah untuk Masa Depan Indonesia'); ?>

                    </h2>
                </div>

                <p class="text-xs sm:text-sm text-white/90 leading-relaxed mb-3 sm:mb-4">
                    <?php echo e($isEnglish
