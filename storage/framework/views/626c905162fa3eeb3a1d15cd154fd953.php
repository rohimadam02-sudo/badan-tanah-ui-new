        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" x-data="asetPage()" x-init="init()">
            ...
            <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 mb-8">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                    ...
                    <div
                        class="sm:col-span-1 lg:col-span-3 flex flex-col sm:flex-row justify-end items-stretch sm:items-end gap-3">
                    ...
                    <template x-for="item in paginatedAssets" :key="item.id">
                        <article
                            ...
                            <span class="absolute top-4 left-4 text-white text-[10px] px-3 py-1.5 rounded-md font-bold uppercase tracking-wide"
                                ...
                                bg - [#006400]' : (item.status === 'Dalam Pengembangan' ? 'bg-blue-600' : 'bg-orange-500')"
                        ...
                        <template x-for="page in getVisiblePages()" :key="page">
                            ...
                            <template x-if="page !== '...'">
                                <button type="button" @click="changePage(page)"
                                    ...
                                    :class="page === currentPage ? 'bg-[#006400] text-white border-[#006400] shadow-sm' :
        ...
        function asetPage() {
            return {
                ...
                `);
                    ...
                    const validAssets = assets.filter(item => Number.isFinite(Number(item.lat)) && Number.isFinite(Number(
                        item.lng)));
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/u250369146/laravel-app/resources/views/frontend/assets.blade.php ENDPATH**/ ?>