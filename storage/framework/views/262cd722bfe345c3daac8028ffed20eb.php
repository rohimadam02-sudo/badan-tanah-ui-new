        ...
        <nav class="flex-1 p-3 space-y-0.5 sidebar-scroll" aria-label="Main Navigation">
            ...
            <?php if(in_array($role, ['super_admin', 'admin'])): ?>
                ...
                <div x-data="{ open: <?php echo e($websiteOpen ? 'true' : 'false'); ?> }" class="relative">
                    ...
                    <?php echo e($websiteOpen ? 'bg-[#006400] text-white shadow-sm' : 'text-gray-700 hover:bg-gray-100 hover:text-[#00640]'); ?>"
...
<?php /**PATH /home/u250369146/laravel-app/resources/views/layouts/admin.blade.php ENDPATH**/ ?>