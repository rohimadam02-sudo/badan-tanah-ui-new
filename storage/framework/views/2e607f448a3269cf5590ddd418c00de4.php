                        ...
                        <div class="relative w-full h-full overflow-hidden" id="aboutSlider" style="min-height: 350px;">
                                ...
                                <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="min-w-full h-full flex-shrink-0 flex items-center justify-center bg-gray-100">
                                        <img
                                            ...
                                            alt="<?php echo e($halaman->judul); ?> - Foto <?php echo e($index + 1); ?>"
                            ...
                            <?php if($totalImages > 1): ?>
                                ...
                                <div class="slider-dots" id="aboutSliderDots">
                                    <?php $__currentLoopData = $images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" class="slider-dot <?php echo e($index === 0 ? 'active' : ''); ?>" data-slide="<?php echo e($index); ?>"></button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>

                                
                                <div class="slider-counter">
                                    <span id="aboutSliderCurrent">1</span> / <span id="aboutSliderTotal"><?php echo e($totalImages); ?></span>
                                </div>
                            <?php endif; ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 md:p-8">
                ...
                <div class="border-l-4 border-blue-600 pl-5">
                    <p class="text-gray-600 leading-8 text-sm md:text-base">
                        <?php echo nl2br(e($halaman->visi ?? 'Visi Badan Bank Tanah ditampilkan berdasarkan konten resmi yang dikelola melalui CMS.')); ?>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-7 md:p-8">
                ...
                <div class="border-l-4 border-green-600 pl-5">
                    <p class="text-gray-600 leading-8 text-sm md:text-base whitespace-pre-line">
                        <?php echo nl2br(e($halaman->misi ?? 'Misi Badan Bank Tanah ditampilkan berdasarkan konten resmi yang dikelola melalui CMS.')); ?>
                    ...
                    <div class="tree-view min-w-[600px]">
                        <div class="flex flex-col items-center">
                            ...
                            <div class="bg-[#0B2A4A] text-white px-6 py-3 rounded-xl font-bold text-sm shadow-md">
                                <?php echo e($lines[0] ?? 'Struktur Organisasi'); ?>
                                ...
                                <div class="flex flex-wrap justify-center gap-4 gap-y-6 mt-2">
                                    <?php $__currentLoopData = array_slice($lines, 1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $line): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="flex flex-col items-center min-w-[140px]">
                                            <div class="bg-<?php echo e($bgColor); ?> border border-<?php echo e($borderColor); ?> px-4 py-2.5 rounded-lg text-xs font-semibold text-<?php echo e($textColor); ?> shadow-sm text-center">
                                                <?php echo e($clean); ?>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-sm text-gray-500 leading-7 mt-2 whitespace-pre-line">
                            <?php echo nl2br(e($halaman->dasar_hukum ?? 'Informasi dasar hukum ditampilkan berdasarkan dokumen dan konten resmi yang dikelola melalui CMS.')); ?>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/frontend/about.blade.php ENDPATH**/ ?>