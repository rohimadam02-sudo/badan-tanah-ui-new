<?php $__env->startSection('title', 'Integrasi'); ?>
...
<div class="max-w-5xl mx-auto">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <form action="<?php echo e(route('admin.integrasi.update')); ?>" method="POST">
            <?php echo csrf_field(); ?>
                ...
                <div class="border-b border-gray-100 pb-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-3">
                                <input type="text" name="google_analytics" value="<?php echo e(old('google_analytics', $pengaturan->google_analytics ?? '')); ?>"
                ...
                <div class="border-b border-gray-100 pb-6">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="flex-1">
                            ...
                            <div class="mt-3">
                                <input type="text" name="kimi_api_key" value="<?php echo e(old('kimi_api_key', $pengaturan->kimi_api_key ?? '')); ?>"
                                ...
                                <div class="flex items-center gap-2 mt-2">
                                    <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold
                                        <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'bg-green-50 text-green-700' : 'bg-yellow-50 text-yellow-700'); ?>">
                                        <span class="w-1.5 h-1.5 rounded-full <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'bg-green-500' : 'bg-yellow-500'); ?>"></span>
                                        <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'Terhubung' : 'Belum Terhubung'); ?>
                            ...
                            <div class="mt-3 flex items-center gap-3">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="qr_enabled" value="1"
                                        <?php echo e(old('qr_enabled', $pengaturan->qr_enabled ?? false) ? 'checked' : ''); ?>
                                    ...
                                    <span class="ms-3 text-sm font-medium text-gray-700">
                                        <span x-data="{ checked: <?php echo e(old('qr_enabled', $pengaturan->qr_enabled ?? false) ? 'true' : 'false'); ?>}">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap items-center gap-3 mt-1">
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold bg-green-50 text-green-700">
                                    ...
                                    Google Analytics: <?php echo e(($pengaturan->google_analytics ?? '') ? 'Terkonfigurasi' : 'Belum'); ?>

                                </span>
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'bg-green-50 text-green-700' : 'bg-yellow-50 text-yellow-700'); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'bg-green-500' : 'bg-yellow-500'); ?>"></span>
                                    Kimi K2.5: <?php echo e(($pengaturan->kimi_api_key ?? '') ? 'Terkonfigurasi' : 'Belum'); ?>

                                </span>
                                <span class="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-bold <?php echo e(($pengaturan->qr_enabled ?? false) ? 'bg-green-50 text-green-700' : 'bg-gray-50 text-gray-500'); ?>">
                                    <span class="w-1.5 h-1.5 rounded-full <?php echo e(($pengaturan->qr_enabled ?? false) ? 'bg-green-500' : 'bg-gray-400'); ?>"></span>
                                    QR Code: <?php echo e(($pengaturan->qr_enabled ?? false) ? 'Aktif' : 'Nonaktif'); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/integrasi.blade.php ENDPATH**/ ?>