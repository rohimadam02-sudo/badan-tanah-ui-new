<?php $__env->startSection('title', 'Karier - Badan Bank Tanah'); ?>
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 text-center">
                <p class="text-2xl font-bold text-[#006400]"><?php echo e($kariers->count()); ?></p>
                <p class="text-xs text-gray-500">Total Lowongan</p>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 text-center">
                <p class="text-2xl font-bold text-blue-600"><?php echo e($kariers->where('status', 'Buka')->count()); ?></p>
                <p class="text-xs text-gray-500">Lowongan Aktif</p>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 text-center">
                <p class="text-2xl font-bold text-purple-600"><?php echo e($kariers->pluck('lokasi')->unique()->count()); ?></p>
                <p class="text-xs text-gray-500">Lokasi</p>
            </div>
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 text-center">
                <p class="text-2xl font-bold text-orange-500"><?php echo e($kariers->where('status', 'Tutup')->count()); ?></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6" id="karierList">
            <?php $__empty_1 = true; $__currentLoopData = $kariers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $karier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="karier-item bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-lg transition group" data-status="<?php echo e($karier->status); ?>">
                <div class="p-6">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h3 class="font-bold text-base text-gray-900 group-hover:text-[#006400] transition line-clamp-1">
                                    <?php echo e($karier->judul); ?>

                                </h3>
                                <div class="flex items-center gap-2 text-xs text-gray-500 mt-0.5">
                                    <i class="fas fa-location-dot"></i>
                                    <span><?php echo e($karier->lokasi ?? 'Tidak ditentukan'); ?></span>
                                </div>
                            </div>
                        </div>
                        <span class="status-badge px-3 py-1 rounded-full text-[10px] font-bold whitespace-nowrap
                            <?php echo e($karier->status == 'Buka' ? 'bg-green-50 text-green-700' : 'bg-gray-100 text-gray-500'); ?>">
                            <?php echo e($karier->status == 'Buka' ? '● Buka' : '● Tutup'); ?>

                        </span>
                    </div>

                    <p class="text-sm text-gray-600 leading-relaxed line-clamp-2 mb-4">
                        <?php echo e($karier->deskripsi); ?>

                    </p>

                    <div class="flex flex-wrap items-center gap-2 mb-4">
                        <span class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Kualifikasi:</span>
                        <span class="text-xs text-gray-600 line-clamp-1"><?php echo e(Str::limit($karier->kualifikasi, 60)); ?></span>
                    </div>
                    ...
                    <div class="karier-detail hidden mt-4 pt-4 border-t border-gray-100">
                        <div class="grid grid-cols-1 gap-3 text-sm">
                            <div>
                                ...
                                <p class="text-gray-600 leading-relaxed mt-1"><?php echo e($karier->deskripsi); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Kualifikasi</p>
                                <p class="text-gray-600 leading-relaxed mt-1"><?php echo e($karier->kualifikasi); ?></p>
                            </div>
                            <div>
                                <p class="text-[10px] font-semibold text-gray-400 uppercase tracking-wider">Lokasi</p>
                                <p class="text-gray-600 mt-1"><?php echo e($karier->lokasi ?? 'Tidak ditentukan'); ?></p>
                            </div>
                            <div class="mt-2">
                                
                                
                                
                                <a href="<?php echo e(route('karier.lamar', $karier->id)); ?>" 
        ...
        <div class="mt-10 bg-gradient-to-r from-[#0B2A4A] to-[#163F66] rounded-2xl p-8 text-center">
            ...
            <a href="<?php echo e(route('kontak')); ?>" class="inline-flex items-center gap-2 bg-white text-[#0B2A4A] hover:bg-gray-100 px-6 py-3 rounded-xl font-bold text-sm transition">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Lenovo\badan-tanah-ui-new\resources\views/frontend/karier.blade.php ENDPATH**/ ?>