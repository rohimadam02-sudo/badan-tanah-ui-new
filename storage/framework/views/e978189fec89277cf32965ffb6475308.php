        ...
        <div class="space-y-4">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="px-4 py-3 border-b border-gray-100 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(route('admin.aset.wilayah')); ?>" class="text-[8px] text-blue-600 hover:underline">Lihat Semua</a>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $provinsiData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <span class="text-[8px] text-gray-400"><?php echo e(number_format($item->total_luas, 0, ',', '.')); ?> Ha</span>
                            </div>
                            <div class="h-1.5 bg-gray-100 rounded-full overflow-hidden">
                                <div class="h-full bg-[#006400] rounded-full" style="width: <?php echo e(min(100, ($item->total_luas / $maxLuas) * 100)); ?>%"></div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/aset_peta.blade.php ENDPATH**/ ?>