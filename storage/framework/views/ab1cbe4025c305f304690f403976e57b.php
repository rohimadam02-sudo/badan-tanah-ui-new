<?php $__env->startSection('title', 'Pengelolaan Tanah'); ?>
        ...
        <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-5">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <h3 class="text-2xl font-bold text-blue-600 mt-2"><?php echo e(number_format($totalPengembangan)); ?></h3>
                </div>
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $asets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-5 py-4">
                                ...
                                ?>
                                <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[8px] font-semibold <?php echo e($statusColor); ?>">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\rohim\badan-tanah-ui-new\resources\views/admin/aset_pengelolaan.blade.php ENDPATH**/ ?>